...
export function classifyUrl(url: string): PageType {
  ...
  if (noLang.startsWith('/tools/rotator') || noLang.startsWith('/tools/cropper') || noLang.startsWith('/tools/watermark') || noLang.startsWith('/tools/metadata') || noLang.startsWith('/tools/passport') || noLang.startsWith('/tools/heic-converter') || noLang.startsWith('/tools/signature') || noLang.startsWith('/tools/image-to-pdf')) return 'tool';
