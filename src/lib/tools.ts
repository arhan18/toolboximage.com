...
export const tools: ToolConfig[] = [
  ...
  },
  {
    ...
    shortName: 'Passport',
    description: 'Create passport and ID photos with correct dimensions, background color, and print layout',
    longDescription: 'Create professional passport and ID photos for US, UK, EU, India, Canada, Australia, China, Japan, and more. Crop to exact government dimensions, choose background color, and download as a single photo or printable 4×6 sheet.',
    icon: 'image',
    path: '/tools/passport/',
    category: 'transform',
    status: 'live',
