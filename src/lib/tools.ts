...
export const tools: ToolConfig[] = [
  ...
  },
  {
    ...
    shortName: 'Signature',
    description: 'Resize signature images for email, documents, and digital signing',
    longDescription: 'Resize your signature image to standard sizes for email signatures, digital documents, and online forms. Choose from preset sizes or enter custom dimensions. Output as PNG with white or transparent background.',
    icon: 'image',
